...
public class DbConnection {
    private String dbURL = "jdbc:mysql://localhost:3306/databasetest";
    ...
    public void insertRecord(String name,String email, String password, String phoneNo){
        try {
            String sqlQuery = "INSERT INTO user(name,email,password,phoneno) VALUES(?,?,?,?)";
